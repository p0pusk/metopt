...
class Interface:
    ...
    def __create_window(self):
        layout = [
            ...
            [
                sg.Text(
                    "Введите 3 равенства в виде a1 a2 ... an = b, где a1 a2 ... an -"
                    " коэффициенты, а b - правая часть:"
                )
            ],
            ...
            [
                sg.Text(
                    "Введите неравенство в виде a1 a2 ... an <= b, где a1 a2 ... an -"
                    " коэффициенты, а b - правая часть"
                )
            ],
            [sg.InputText()],
            ...
            [
                sg.Text(
                    'Введите индексы переменных, имеющих ограничения на знак(в виде "i1'
                    ' i2 ... in":)'
                )
            ],
            [sg.InputText()],
